package com.anbang.qipai.dapaomajiang;
...
import com.anbang.qipai.dapaomajiang.cqrs.c.repository.SingletonEntityFactoryImpl;
import com.anbang.qipai.dapaomajiang.cqrs.c.service.disruptor.CoreSnapshotFactory;
import com.anbang.qipai.dapaomajiang.cqrs.c.service.disruptor.ProcessCoreCommandEventHandler;
import com.anbang.qipai.dapaomajiang.cqrs.c.service.disruptor.SnapshotJsonUtil;
import com.anbang.qipai.dapaomajiang.init.InitProcessor;
import com.dml.users.UserSessionsManager;
import com.highto.framework.ddd.SingletonEntityRepository;

@SpringBootApplication
@EnableScheduling
public class QipaiDianpaomajiangApplication {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(QipaiDianpaomajiangApplication.class, args);
	}
