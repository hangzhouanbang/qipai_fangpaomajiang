...
import com.anbang.qipai.fangpaomajiang.cqrs.c.domain.FangpaoMajiangTaishu;

public class FangpaoMajiangTaishuVO {
	...
	public FangpaoMajiangTaishuVO(FangpaoMajiangTaishu taishu) {
