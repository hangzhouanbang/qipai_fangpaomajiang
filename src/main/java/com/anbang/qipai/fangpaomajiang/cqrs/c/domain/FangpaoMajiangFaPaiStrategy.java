 ...
 *
 */
public class FangpaoMajiangFaPaiStrategy implements FaPaiStrategy {

	private int faPaiCountsForOnePlayer;

	public FangpaoMajiangFaPaiStrategy() {
	}

	public FangpaoMajiangFaPaiStrategy(int faPaiCountsForOnePlayer) {
